...
**Snake Pro** — современная версия классической игры «Змейка», реализованная на **C++ и Qt 6**. Игра сочетает классическую механику с современным визуальным оформлением, анимациями и удобным интерфейсом.
